...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".gitignore",
     ...
     "app/views/admin/optimizations/_details.rhtml",
     "app/views/admin/optimizations/edit.rhtml",
     "app/views/admin/optimizations/index.rhtml",
     ...
     "app/views/admin/product_options/_option_list.rhtml",
     "app/views/admin/product_options/_option_selection_form.rhtml",
     "app/views/admin/product_options/_option_selection_image_form.rhtml",
     "app/views/admin/product_options/_option_selection_image_list.rhtml",
     "app/views/admin/product_options/_option_selection_images.rhtml",
     ...
     "app/views/admin/products/_categories.rhtml",
     "app/views/admin/products/_category_list.rhtml",
     "app/views/admin/products/_details.rhtml",
     ...
     "app/views/admin/products/faux_products/_faux_products.rhtml",
     "app/views/admin/products/images/_image_form.rhtml",
     "app/views/admin/products/images/_image_large_form.rhtml",
     "app/views/admin/products/images/_image_large_list.rhtml",
     "app/views/admin/products/images/_image_list.rhtml",
     "app/views/admin/products/images/_image_thumbnail_form.rhtml",
     "app/views/admin/products/images/_image_thumbnail_list.rhtml",
     "app/views/admin/products/images/_images.rhtml",
     "app/views/admin/products/index.rhtml",
     "app/views/admin/products/new.rhtml",
     ...
     "app/views/admin/products/show.rhtml",
     "app/views/admin/products/wholesale/_quantity_discount.rhtml",
     "app/views/admin/products/wholesale/_wholesale.rhtml",
     ...
     "app/views/admin/shipping_methods/_fulfillment_code.rhtml",
     "app/views/admin/shipping_methods/_navigation.rhtml",
     "app/views/admin/shipping_methods/edit.rhtml",
     "app/views/admin/shipping_methods/index.rhtml",
     "app/views/admin/shipping_methods/new.rhtml",
     "app/views/admin/stores/_details.rhtml",
     "app/views/admin/stores/_image_form.rhtml",
     "app/views/admin/stores/_image_list.rhtml",
     "app/views/admin/stores/_images.rhtml",
     "app/views/admin/stores/_sidebar.html.erb",
     "app/views/admin/stores/edit.rhtml",
     "app/views/admin/stores/index.rhtml",
     "app/views/admin/stores/new.rhtml",
     "app/views/admin/stores/show.rhtml",
     "app/views/admin/vendors/_details.rhtml",
     "app/views/admin/vendors/edit.rhtml",
     "app/views/admin/vendors/index.rhtml",
     "app/views/admin/vendors/new.rhtml",
     "app/views/admin/vendors/show.rhtml",
     "app/views/carts/_cart.rhtml",
     "app/views/carts/_cart_item.rhtml",
     "app/views/carts/_cart_item_selections.rhtml",
     "app/views/carts/_cart_totals.rhtml",
     "app/views/carts/_promo_code.html.erb",
     "app/views/carts/_shipping_methods.rhtml",
     "app/views/carts/_shipping_regions.rhtml",
     "app/views/carts/_shipping_totals.rhtml",
     "app/views/carts/index.rhtml",
     ...
     "app/views/index/_featured_products.rhtml",
     "app/views/index/about.rhtml",
     "app/views/index/charity.rhtml",
     "app/views/index/contact_us.rhtml",
     ...
     "app/views/orders/_billing_address.rhtml",
     "app/views/orders/_billing_shipping_info.rhtml",
     "app/views/orders/_order_item.rhtml",
     "app/views/orders/_order_item_selection.rhtml",
     "app/views/orders/_payment_method.rhtml",
     "app/views/orders/_paypal_form.rhtml",
     "app/views/orders/_paypal_item.rhtml",
     "app/views/orders/_promo_code.html.erb",
     "app/views/orders/_receipt.rhtml",
     "app/views/orders/_review.rhtml",
     "app/views/orders/_shipping_address.rhtml",
     "app/views/orders/_tax.erb.html",
     "app/views/orders/create.rhtml",
     "app/views/orders/new.rhtml",
     "app/views/orders/status.rhtml",
     ...
     "app/views/products/_product_options.rhtml",
