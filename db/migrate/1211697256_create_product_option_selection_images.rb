class CreateProductOptionSelectionImages < ActiveRecord::Migration
  def self.up
    create_table :product_option_selection_images do |table|
  ...
  def self.down
    drop_table :product_option_selection_images
  end
end
